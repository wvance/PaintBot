%*******************************************************************************
% Name			: Nicholas Warner, Wesley Vance
...
% Last Modified by GUIDE v2.5 31-Mar-2016 11:43:05
...
% --- Executes on button press in stop_server.
function stop_server(hObject, eventdata, handles)
global tcpipServer;
global toggle2;

'Hi I am the server, ending session'
toggle2 = false;
fclose(tcpipServer);
'Disconnected'
% hObject    handle to stop_server (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
